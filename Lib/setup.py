...
description="This is a Personal Python Module created by Jaipal. It is only accessible to Jaipal. Copy these files and save these inside a folder named Lib. And save that folder where your python libraries are present and you access it too by using 'import Lib'",
